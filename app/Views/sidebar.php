      ...
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li class=" navigation-header"><span data-i18n="nav.category.input">Input</span><i class="ft-more-horizontal ft-minus" data-toggle="tooltip" data-placement="right" data-original-title="Input"></i>
            ...
            <a href="<?= base_url('/') ?>">
                <i class="icon-home"></i>
                <span class="menu-title" data-i18n="nav.dash.main">Ayam Masuk</span>
            </a>
          </li>
          <li class=" nav-item">
            <a href="<?= base_url('/') ?>">
                <i class="icon-home"></i>
                <span class="menu-title" data-i18n="nav.dash.main">Ayam Mati & Sisa</span>
            </a>
          </li>
          <li class=" nav-item">
            <a href="<?= base_url('/') ?>">
                <i class="icon-home"></i>
                <span class="menu-title" data-i18n="nav.dash.main">Omset & DO</span>
            </a>
          </li>
          ...
          <li class=" nav-item"><a href="#"><i class="icon-layers"></i><span class="menu-title" data-i18n="nav.page_layouts.main">Page layouts</span></a>
            <ul class="menu-content">
              ...
              <li class="active"><a class="menu-item" href="layout-dark.html" data-i18n="nav.page_layouts.dark_layout">Dark layout</a>
              </li>
